...
df = pd.read_csv("https://raw.githubusercontent.com/alfendio/Bike-Sharing-Data-Analysis/main/data/dataset_clean.csv")
...
fig1 = px.bar(seasonly_users_df,
              ...
              y=['count_rides'],
              color='type_of_rides',
              color_discrete_sequence=["deepskyblue", "orange"],
...
fig = px.line(hourly_users_df,
              ...
              color_discrete_sequence=["green", "orangered"],
              markers=True,
